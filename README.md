# Camada de negócio para Aplicação de Sistemas Distribuídos

Este repositório contém o código-fonte da camada de negócio desenvolvido pelo grupo para a disciplina de Desenvolvimento de Sistemas Distribuídos do curso de Análise e Desenvolvimento de Sistemas do 5º semestre. Neste projeto, nosso grupo é responsável pela implementação da camada de negócio de uma aplicação distribuída.
...
O objetivo deste projeto é desenvolver a camada de negócio de uma aplicação de Sistemas Distribuídos, que será responsável por gerenciar a lógica de negócios e a comunicação com outros componentes distribuídos.
